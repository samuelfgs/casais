...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: LvzZwu2COXKn/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__kdh8A)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__l7NN2)}
              role={"img"}
            />
          ),
